INSERT INTO organization.Departments (DepartmentID, DepartmentName) VALUES
(1, 'Отдел продаж'),
(2, 'Отдел маркетинга'),
(3, 'IT-отдел'),
(4, 'Отдел разработки'),
(5, 'Отдел поддержки');
-- Добавление ролей
INSERT INTO organization.Roles (RoleID, RoleName) VALUES
(1, 'Менеджер'),
(2, 'Директор'),
...
INSERT INTO organization.Employees (EmployeeID, Name, Position, ManagerID, DepartmentID, RoleID) VALUES
...
-- Добавление проектов
INSERT INTO organization.Projects (ProjectID, ProjectName, StartDate, EndDate, DepartmentID) VALUES
...
-- Добавление задач
INSERT INTO organization.Tasks (TaskID, TaskName, AssignedTo, ProjectID) VALUES
